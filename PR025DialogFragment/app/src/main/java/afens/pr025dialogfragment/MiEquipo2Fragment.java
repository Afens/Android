 ...
 */
public class MiEquipo2Fragment extends DialogFragment {
    private String[] equipos;
    private int selec=0;

    public interface MiEquipo2Listener {
        public void onEquipoSeleccionado(DialogFragment dialog, String equipo);

    }

    MiEquipo2Listener listener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setPositiveButton("Enviar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                listener.onEquipoSeleccionado(MiEquipo2Fragment.this, equipos[selec]);
            }
        });
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            listener = (MiEquipo2Listener) activity;
